                ...
                {activeSocials.map(([platform, url]) => {
                    ...
                    return (
                        <a
                            ...
                            className="w-10 h-10 rounded-full border border-pure-white/15 flex items-center justify-center text-pure-white/70 hover:text-brand-24e1c9 hover:border-brand-24e1c9/60 hover:bg-brand-24e1c9/10 transition-all duration-200"
                        >
                            {social.icon}
                        </a>
                    );
