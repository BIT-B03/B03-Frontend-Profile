...
export default function WhyChooseUs() {
  return (
    <section className="mt-12 sm:mt-16 md:mt-24 lg:mt-28 mb-14 sm:mb-20 space-y-10 sm:space-y-12">
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
        <div className="md:flex-1 min-w-0 md:pr-4">
          <h3 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4">Why Choose Us!</h3>
